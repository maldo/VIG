...
QDataStream &operator<<(QDataStream &, const Point &);
QDataStream &operator>>(QDataStream &, Point &);
...
QDataStream &operator<<(QDataStream &, const Vector &);
QDataStream &operator>>(QDataStream &, Vector &);

...
QDataStream &operator<<(QDataStream &ds, const Point &p)
{
    ds << p.x;
    ds << p.y;
    ds << p.z;
...
QDataStream &operator>>(QDataStream &ds, Point &p)
{
    ds >> p.x;
    ds >> p.y;
    ds >> p.z;
...
QDataStream &operator<<(QDataStream &ds, const Vector &v)
{
    ds << v.x;
    ds << v.y;
    ds << v.z;
...
QDataStream &operator>>(QDataStream &ds, Vector &v)
{
    ds >> v.x;
    ds >> v.y;
    ds >> v.z;
